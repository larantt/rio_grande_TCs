...
# filepaths to data
IMERG_PATH = "/nfs/turbo/seas-hydro/laratt/IMERG_3B/"
...
SWATH_OUTPATH = "/nfs/turbo/seas-hydro/laratt/TCdata/precip_swaths/IMERG_3B"
...
TRACKS_FROM_DISK = "/nfs/turbo/seas-hydro/laratt/TCdata/track_files/2024-10-03_tracks_2000-2020.pkl"    # string filepath - read in clean data that has been saved to disk to skip IO and cleaning EBT overhead
